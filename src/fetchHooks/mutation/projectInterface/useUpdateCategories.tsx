...
import { UpdateCategoriesById } from "../../../ServerTypes/ProjectInterface"
...
export default () => {
    return useMutation({
        mutationFn: async (request: UpdateCategoriesById) => {
            await toast.promise(axiosClient.post('/project-interface/categories/update-by-id', request), {
                pending: {
                    render () { return <Text c="black">Update New Category ...</Text> }
                },
                success: {
