...
import { SourceOfFunds } from "../../../ServerTypes/ProjectInterface"
...
export default () => {
    return useMutation({
        mutationKey: ['add-sof'],
        mutationFn: async (request: SourceOfFunds) => {
            await toast.promise(axiosClient.post('/project-interface/source-of-funds/add', request), {
                pending: {
                    render () { return <Text c="black">Adding New SOF ...</Text> }
                },
                success: {
