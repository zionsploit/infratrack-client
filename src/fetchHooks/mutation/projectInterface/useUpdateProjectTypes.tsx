...
import { UpdateProjectTypesById } from "../../../ServerTypes/ProjectInterface"
...
export default () => {
    return useMutation({
        mutationFn: async (request: UpdateProjectTypesById) => {
            await toast.promise(axiosClient.post('/project-interface/project-types/update-by-id', request), {
                pending: {
                    render () { return <Text c="black">Update New Project Types ...</Text> }
                },
                success: {
