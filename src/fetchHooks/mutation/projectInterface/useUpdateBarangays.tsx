...
import { UpdateBarangaysById } from "../../../ServerTypes/ProjectInterface"
...
export default () => {
    return useMutation({
        mutationFn: async (request: UpdateBarangaysById) => {
            await toast.promise(axiosClient.post('/project-interface/barangays/update-by-id', request), {
                pending: {
                    render () { return <Text c="black">Update New Barangay ...</Text> }
                },
                success: {
